...
class Attendance(object):
    def setupUi(self, MainWindow):
        ...
        self.btnDatabase = QtWidgets.QPushButton(self.layoutWidget)
        self.btnDatabase.setObjectName("btnDatabase")
        self.btnDatabase.setFixedSize(100, 30)
        self.btnDatabase.clicked.connect(lambda: self.database(MainWindow))
        self.btnDatabase.setStyleSheet("background-color: #85c9e8;")
        self.verticalLayout.addWidget(self.btnBack)
        self.verticalLayout.addWidget(self.btnDatabase)
